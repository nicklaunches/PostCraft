/**
 * @fileoverview Loading state for template editing page
 *
 * Displays skeleton placeholders while the template data is being fetched
 * and the editor is being initialized. Shows a layout matching the final
 * template editor interface with form fields and editor area.
 *
 * Features:
